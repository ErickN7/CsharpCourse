...
public class SaleWithTax : Sale
{
    ...
    {
        //return base.GetTotal() * 1.16m;//La m es para determinal que el numero es decimal y no un double
        return base.GetTotal() * _tax;//La m es para determinal que el numero es decimal y no un double
    }
}
